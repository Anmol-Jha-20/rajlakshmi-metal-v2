                ...
                {expandedSections.importedProducts && (
                  <div className="bg-white">
                    ...
                    <Link to={"/brass-stripe-patti"}>
                      {" "}
                      <MenuItem title="Brass Stripe Patti" isActive={true} />
                    </Link>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div className="order-2 lg:order-1">
                  <div className="bg-gray-100 rounded-lg overflow-hidden aspect-video">
                    <img
                      src="https://5.imimg.com/data5/SELLER/Default/2022/10/XL/KX/IE/124968442/brass-stripe-patti-500x500.jpeg"
...
export default BrassStripePatti;
